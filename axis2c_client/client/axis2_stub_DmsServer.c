      ...
      /**
       * axis2_stub_DmsServer C implementation
       */
                                      ...
                                      axis2_char_t *endpoint_uri)
      {
         ...
         {
            endpoint_uri = axis2_stub_get_endpoint_uri_of_DmsServer(env);
         }
         ...
         axis2_stub_populate_services_for_DmsServer(stub, env);
         return stub;
      }


      void
      axis2_stub_populate_services_for_DmsServer(axis2_stub_t *stub, const axutil_env_t *env)
      {
         ...
         svc_qname = axutil_qname_create(env,"DmsServer" ,NULL, NULL);
      ...
      axis2_stub_get_endpoint_uri_of_DmsServer( const axutil_env_t *env )
      {
        ...
        /* set the address from here */
              ...
              endpoint_uri = "http://localhost:8080/axis2/services/DmsServer";
        ...
        return endpoint_uri;
                                              ...
                                              adb_ProductComplete_t* _productComplete)
         {
            ...
            adb_ProductCompleteResponse_t* ret_val = NULL;
            
                       payload = adb_ProductComplete_serialize(_productComplete, env, NULL, NULL, AXIS2_TRUE, NULL, NULL);
            ...
            if (NULL == soap_action)
            {
              ...
              soap_action = "urn:ProductComplete";
              
              soap_act = axutil_string_create(env, "urn:ProductComplete");
            ...
            if (!is_soap_act_set)
            {
              ...
              axis2_options_set_action( options, env, NULL);
                    ...
                    ret_val = adb_ProductCompleteResponse_create(env);

                    if(adb_ProductCompleteResponse_deserialize(ret_val, env, &ret_node, NULL, AXIS2_FALSE ) == AXIS2_FAILURE)
                    {
                        if(ret_val != NULL)
                        {
                            adb_ProductCompleteResponse_free(ret_val, env);
                        }

                        AXIS2_LOG_ERROR( env->log, AXIS2_LOG_SI, "NULL returnted from the ProductCompleteResponse_deserialize: "
        ...
        struct axis2_stub_DmsServer_ProductComplete_callback_data
        {   
            void *data;
        ...
        static axis2_status_t AXIS2_CALL axis2_stub_on_error_DmsServer_ProductComplete(axis2_callback_t *callback, const axutil_env_t *env, int exception)
        {
            axis2_status_t ( AXIS2_CALL *on_error ) (const axutil_env_t *, int, void *data);
            struct axis2_stub_DmsServer_ProductComplete_callback_data* callback_data = NULL;
            void *user_data = NULL;

            axis2_status_t status;
        
            callback_data = (struct axis2_stub_DmsServer_ProductComplete_callback_data*)axis2_callback_get_data(callback);
        ...
        axis2_status_t AXIS2_CALL axis2_stub_on_complete_DmsServer_ProductComplete(axis2_callback_t *callback, const axutil_env_t *env)
        {
            axis2_status_t ( AXIS2_CALL *on_complete ) (const axutil_env_t *, adb_ProductCompleteResponse_t* _productCompleteResponse, void *data);
            struct axis2_stub_DmsServer_ProductComplete_callback_data* callback_data = NULL;
            void *user_data = NULL;
        ...
        /**
                                                  ...
                                                  axis2_status_t ( AXIS2_CALL *on_error ) (const axutil_env_t *, int exception, void *data) )
         {
            ...
            struct axis2_stub_DmsServer_ProductComplete_callback_data *callback_data;

            callback_data = (struct axis2_stub_DmsServer_ProductComplete_callback_data*) AXIS2_MALLOC(env->allocator, 
                                    sizeof(struct axis2_stub_DmsServer_ProductComplete_callback_data));
            ...
            axis2_callback_set_on_complete(callback, axis2_stub_on_complete_DmsServer_ProductComplete);
            /* Set our on_error function pointer to the callback object */
            axis2_callback_set_on_error(callback, axis2_stub_on_error_DmsServer_ProductComplete);
